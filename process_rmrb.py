...
if __name__ == "__main__":
    ...
    write_file(sens[:dev_length], labels[:dev_length], "data/few_data/dev.txt")
    write_file(sens[dev_length:2*dev_length], labels[dev_length:2*dev_length], "data/few_data/test.txt")
    write_file(sens[2*dev_length:], labels[2*dev_length:], "data/few_data/train.txt")
